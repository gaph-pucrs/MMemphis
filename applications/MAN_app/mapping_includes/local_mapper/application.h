...
/**
 * \brief This structure stores the communication consumer of a given task
 * \detailed This structure is fulfilled during the reception of a new application.
 * Thus, the application repository keeps the consumer information for each task
 */
typedef struct {
...
typedef struct {
	...
	int  status;					//!< Stores the application's status
...
typedef struct {
	...
	int is_secure;				//!< Stores if the application is secure
