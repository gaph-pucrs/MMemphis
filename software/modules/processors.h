...
typedef struct {
	...
	int utilization[MAX_LOCAL_TASKS];	//!<Array with the utilization of the RT task index
...
void update_proc_utilization(int, int, int);

int get_proc_utilization(int);

int get_task_utilization(int, int);

int get_RT_task_number(int);

int get_BE_task_id(int);
...
int get_number_computation_task(int);
