...
def generate_wave_generic(yaml_r, system_model):
    ...
    wave_lines.append(app_injector_monitor + "req_app_cluster_id\n")
    wave_lines.append(app_injector_monitor + "req_app_task_number\n")
    wave_lines.append(app_injector_monitor + "req_app_start_time\n")
    wave_lines.append(app_injector_monitor + "req_app_name\n")
